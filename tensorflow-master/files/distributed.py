...
flags.DEFINE_string('ps_hosts', 'master.gongkun.com:2223', 'Comma-separated list of hostname:port pairs')
# 两个worker节点
flags.DEFINE_string('worker_hosts', 'master.gongkun.com:2222,slave1.gongkun.com:2222,slave2.gongkun.com:2222',
